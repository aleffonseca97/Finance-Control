        ...
        <CardContent className="flex flex-col gap-4 px-4 py-4 sm:px-6 sm:py-5">
          ...
          <Suspense fallback={calendarFallback}>
            <MonthCalendar
              ...
              todayDay={todayDay}
              accentColor="blue"
              entryLabel={tShared('withContribution')}
            />
          </Suspense>
        </CardContent>
      </Card>
      ...
      <div className="min-w-0 space-y-6">
        <Card className="dashboard-bento-card shadow-md">
          <CardHeader className="px-4 pt-4 sm:px-6 sm:pt-5">
            <CardTitle className="text-base sm:text-lg">{t('addContribution')}</CardTitle>
            <p className="text-sm font-normal text-muted-foreground">
              {tShared('investmentContributionHint')}
            </p>
          </CardHeader>
        ...
        <Card className="dashboard-bento-card-muted shadow-md">
          <CardHeader className="px-4 pt-4 sm:px-6 sm:pt-5">
            <CardTitle className="text-base sm:text-lg">{t('makeWithdrawal')}</CardTitle>
            <p className="text-sm font-normal text-muted-foreground">
              {tShared('withdrawalHint')}
            </p>
          </CardHeader>
          <CardContent className="px-4 pb-4 sm:px-6 sm:pb-6">
            <WithdrawalForm
